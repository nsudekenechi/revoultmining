                                    ...
                                    <div class="nk-block-head-content">
                                        <ul class="nk-block-tools gx-3">
                                            <li class="opt-menu-md dropdown">
                                                <a href="#" class="btn btn-dim btn-outline-light btn-icon"
                                            ...
                                            <li><a href="#" class="btn btn-dim btn-outline-light"><span>Withdraw</span>
                                            ...
                                            <div class="nk-wgw">
                                                <div class="nk-wgw-inner">
                                                    ...
                                                    <div class="nk-wgw-balance">
                                                        <div class="amount">40.509505<span
                                                                class="currency currency-nio">NIO</span></div>
                                                        <div class="amount-sm">8,924.63<span
                                                ...
                                                <div class="nk-wgw-actions">
                                                    <ul>
                                                        <li><a href="#"><em class="icon ni ni-arrow-up-right"></em>
                                                                <span>Send</span></a></li>
                                                        <li><a href="#"><em
                                                                    class="icon ni ni-arrow-down-left"></em><span>Receive</span></a>
                                                        </li>
                                                        <li><a href="#"><em
                                        ...
                                        <div class="card card-bordered">
                                            <div class="nk-wgw">
                                                <div class="nk-wgw-inner">
                                                    ...
                                                    <div class="nk-wgw-balance">
                                                        <div class="amount">0.452058<span
                                                                class="currency currency-eth">ETH</span></div>
                                                        <div class="amount-sm">1,583.25<span
                                                                class="currency currency-usd">USD</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-wgw-actions">
                                        ...
                                        <div class="card card-bordered">
                                            <div class="nk-wgw">
                                                <div class="nk-wgw-inner">
                                                    ...
                                                    <div class="nk-wgw-balance">
                                                        <div class="amount">12,495.90<span
                                                                class="currency currency-usd">USD</span></div>
                                                        <div class="amount-sm">12,495.90<span
                                                                class="currency currency-usd">USD</span></div>
                                                    </div>
                                                </div>
                                                <div class="nk-wgw-actions">
                                        ...
                                        <div class="card card-bordered">
                                            <div class="nk-wgw">
                                                <div class="nk-wgw-inner">
                                                    ...
                                                    <div class="nk-wgw-balance">
                                                        <div class="amount">12,495.90<span
                                                                class="currency currency-eur">EUR</span></div>
                                                        <div class="amount-sm">12,495.90<span
                                                                class="currency currency-usd">USD</span></div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card card-bordered dashed h-100">
                                            <div class="nk-wgw-add">
                                                <div class="nk-wgw-inner">
                                                    ...
                                                    <span class="sub-text">You can add your more wallet in your account
                                                        to manage separetly.</span>
                                                </div>
                                            </div>
                                        </div><!-- .card -->
                                    </div><!-- .col -->
